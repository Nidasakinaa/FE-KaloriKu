...
!function(a,b,c,d) {
    ...
    , {
        filter: ["items","settings"],run:function() {
            ...
            for(g/=2;g--;)b.push(this.normalize(b.length/2,!0)),h+=c[b[b.length-1]][0].outerHTML,b.push(this.normalize(c.length-1-(b.length-1)/2,!0)),i=c[b[b.length-1]][0].outerHTML+i;this._clones=b,a(h).addClass("cloned").appendTo(this.$stage),a(i).addClass("cloned").prependTo(this.$stage)}
    }

    , {
        filter: ["width","items","settings"],run:function() {
            for(var a=this.settings.rtl?1:-1,b=this._clones.length+this._items.length,c=-1,d=0,e=0,f=[];
            ++c<b;)d=f[c-1]||0,e=this._widths[this.relative(c)]+this.settings.margin,f.push(d+e*a);this._coordinates=f}
    }
...
(window.Zepto||window.jQuery,window,document),function(a,b,c,d) {
    ...
    ,e.prototype.fetch=function(a,b) {
        ...
        else if(d[3].indexOf("vimeo")>-1)c="vimeo";else {
